...
## [7.0.0](https://github.com/david-luna/node-mongodb-native/compare/v6.1.0...v7.0.0) (2023-09-18)


### ⚠ BREAKING CHANGES

* **NODE-5584:** adopt bson v6 and mongodb-client-encryption v6 ([#3845](https://github.com/david-luna/node-mongodb-native/issues/3845))
* **NODE-5484:** mark MongoError for internal use and remove Node14 cause assignment logic ([#3800](https://github.com/david-luna/node-mongodb-native/issues/3800))
* **NODE-4788:** use implementer Writable methods for GridFSBucketWriteStream  ([#3808](https://github.com/david-luna/node-mongodb-native/issues/3808))
* **NODE-4986:** remove callbacks from ClientEncryption encrypt, decrypt, and createDataKey ([#3797](https://github.com/david-luna/node-mongodb-native/issues/3797))
* **NODE-5490:** bump kerberos compatibility to ^2.0.1 ([#3798](https://github.com/david-luna/node-mongodb-native/issues/3798))
* **NODE-3568:** ensure includeResultsMetadata is false by default ([#3786](https://github.com/david-luna/node-mongodb-native/issues/3786))
* **NODE-3989:** only accept true and false for boolean options ([#3791](https://github.com/david-luna/node-mongodb-native/issues/3791))
* **NODE-5233:** prevent session from one client from being used on another ([#3790](https://github.com/david-luna/node-mongodb-native/issues/3790))
* **NODE-5444:** emit deprecation warning for useNewUrlParser and useUnifiedTopology ([#3792](https://github.com/david-luna/node-mongodb-native/issues/3792))
* **NODE-5470:** convert remaining FLE to TS and drop support for `onKMSProvidersRefresh` ([#3787](https://github.com/david-luna/node-mongodb-native/issues/3787))
* **NODE-5508:** remove EvalOperation and EvalOptions ([#3795](https://github.com/david-luna/node-mongodb-native/issues/3795))
* **NODE-3920:** validate options are not repeated in connection string ([#3788](https://github.com/david-luna/node-mongodb-native/issues/3788))
* **NODE-3924:** read tls files async ([#3776](https://github.com/david-luna/node-mongodb-native/issues/3776))
* **NODE-5430:** make AutoEncrypter and MongoClient.autoEncrypter internal ([#3789](https://github.com/david-luna/node-mongodb-native/issues/3789))
* **NODE-4961:** remove command result from commit and abort transaction APIs ([#3784](https://github.com/david-luna/node-mongodb-native/issues/3784))
* **NODE-2014:** return executor result from withSession and withTransaction ([#3783](https://github.com/david-luna/node-mongodb-native/issues/3783))
* **NODE-5409:** allow socks to be installed optionally ([#3782](https://github.com/david-luna/node-mongodb-native/issues/3782))
* **NODE-4796:** remove addUser and collection.stats APIs ([#3781](https://github.com/david-luna/node-mongodb-native/issues/3781))
* **NODE-4936:** remove unsupported options from db.command and admin.command ([#3775](https://github.com/david-luna/node-mongodb-native/issues/3775))
* **NODE-5228:** remove unneeded fields from ConnectionPoolCreatedEvent.options ([#3772](https://github.com/david-luna/node-mongodb-native/issues/3772))
* **NODE-5190:** remove deprecated keep alive options ([#3771](https://github.com/david-luna/node-mongodb-native/issues/3771))
* **NODE-5186:** remove duplicate BulkWriteResult accessors ([#3766](https://github.com/david-luna/node-mongodb-native/issues/3766))
* **NODE-5376:** remove deprecated ssl options ([#3755](https://github.com/david-luna/node-mongodb-native/issues/3755))
* **NODE-5415:** bump minimum Node.js version to v16.20.1 ([#3760](https://github.com/david-luna/node-mongodb-native/issues/3760))
* **NODE-5016:** compile ts with target es2020 ([#3545](https://github.com/david-luna/node-mongodb-native/issues/3545))
* **NODE-4522:** remove callback support ([#3499](https://github.com/david-luna/node-mongodb-native/issues/3499))
* **NODE-4817:** remove legacy logger ([#3518](https://github.com/david-luna/node-mongodb-native/issues/3518))
* **NODE-4867:** adopt BSON v5 ([#3490](https://github.com/david-luna/node-mongodb-native/issues/3490))
* **NODE-4738:** remove dot notation support by default ([#3520](https://github.com/david-luna/node-mongodb-native/issues/3520))
* **NODE-4950:** remove bson-ext import ([#3523](https://github.com/david-luna/node-mongodb-native/issues/3523))
* **NODE-4756:** ok 1 with write concern failure event changes ([#3525](https://github.com/david-luna/node-mongodb-native/issues/3525))
* **NODE-4034:** make internal bulk result private ([#3515](https://github.com/david-luna/node-mongodb-native/issues/3515))
* **NODE-4751:** drop support for client encryption < 2.3.0 ([#3521](https://github.com/david-luna/node-mongodb-native/issues/3521))
* **NODE-4684:** remove collection insert, update, remove methods ([#3500](https://github.com/david-luna/node-mongodb-native/issues/3500))
* **NODE-4924:** remove mapReduce collection helper ([#3511](https://github.com/david-luna/node-mongodb-native/issues/3511))
* **NODE-4925:** remove deprecated options and types ([#3513](https://github.com/david-luna/node-mongodb-native/issues/3513))
* **NODE-3818:** remove slaveOk options ([#3503](https://github.com/david-luna/node-mongodb-native/issues/3503))
* **NODE-3695:** remove lastop and optime from bulk result ([#3504](https://github.com/david-luna/node-mongodb-native/issues/3504))
* **NODE-3489:** remove cursor close options ([#3505](https://github.com/david-luna/node-mongodb-native/issues/3505))
* **NODE-4598:** close cursor on early loop break ([#3502](https://github.com/david-luna/node-mongodb-native/issues/3502))
* **NODE-3482:** remove unref ([#3494](https://github.com/david-luna/node-mongodb-native/issues/3494))
* **NODE-4521:** remove custom promise library support ([#3498](https://github.com/david-luna/node-mongodb-native/issues/3498))
* **NODE-4898:** aws credential providers now optional peerDependency ([#3497](https://github.com/david-luna/node-mongodb-native/issues/3497))
* **NODE-4436:** update minimum supported node version ([#3496](https://github.com/david-luna/node-mongodb-native/issues/3496))
* **NODE-4899:** support only snappy 7 or later ([#3491](https://github.com/david-luna/node-mongodb-native/issues/3491))

### Features

* **NODE-2014:** return executor result from withSession and withTransaction ([#3783](https://github.com/david-luna/node-mongodb-native/issues/3783)) ([65aa288](https://github.com/david-luna/node-mongodb-native/commit/65aa288a28a9e8859f4fd75f176961ef3d9747f0))
* **NODE-3255:** add minPoolSizeCheckIntervalMS option to connection pool ([#3429](https://github.com/david-luna/node-mongodb-native/issues/3429)) ([5f34ad0](https://github.com/david-luna/node-mongodb-native/commit/5f34ad07220bfbaf3b9fb6da2fdf67b78b92cb9e))
* **NODE-3445:** add support for AssumeRoleWithWebIdentity in aws authentication ([#3556](https://github.com/david-luna/node-mongodb-native/issues/3556)) ([e8a30b1](https://github.com/david-luna/node-mongodb-native/commit/e8a30b15c8ec6caac770fa08f1201e6b95a5270d))
* **NODE-3482:** remove unref ([#3494](https://github.com/david-luna/node-mongodb-native/issues/3494)) ([556812f](https://github.com/david-luna/node-mongodb-native/commit/556812f2d879fc6f5585b26f6af1db6f08a19b97))
* **NODE-3489:** remove cursor close options ([#3505](https://github.com/david-luna/node-mongodb-native/issues/3505)) ([88c03a1](https://github.com/david-luna/node-mongodb-native/commit/88c03a127adb462047d3b5ecbcb3d390fa8f6c13))
* **NODE-3517:** improve index spec handling and type definitions ([#3315](https://github.com/david-luna/node-mongodb-native/issues/3315)) ([0754bf9](https://github.com/david-luna/node-mongodb-native/commit/0754bf9c322b3a6e0200968ed31b95dd39e76c4b))
* **NODE-3568:** ensure includeResultsMetadata is false by default ([#3786](https://github.com/david-luna/node-mongodb-native/issues/3786)) ([fee8d3e](https://github.com/david-luna/node-mongodb-native/commit/fee8d3e094846222035962c75a207e14b70325c7))
* **NODE-3651:** add hashed index type ([#3432](https://github.com/david-luna/node-mongodb-native/issues/3432)) ([f6b56a1](https://github.com/david-luna/node-mongodb-native/commit/f6b56a17bfd707bb8f42c22af09915dc8b4e6e68))
* **NODE-3695:** remove lastop and optime from bulk result ([#3504](https://github.com/david-luna/node-mongodb-native/issues/3504)) ([8900d40](https://github.com/david-luna/node-mongodb-native/commit/8900d40eaa0476ea672b5d01089229453cacca58))
* **NODE-3750:** make maxConnecting configurable ([#3261](https://github.com/david-luna/node-mongodb-native/issues/3261)) ([ee41447](https://github.com/david-luna/node-mongodb-native/commit/ee414476aa839e364bce6b26ab47859be1b99307))
* **NODE-3818:** remove slaveOk options ([#3503](https://github.com/david-luna/node-mongodb-native/issues/3503)) ([2e28009](https://github.com/david-luna/node-mongodb-native/commit/2e28009892cca6db9564fba9822a321f7900f44b))
* **NODE-3875:** support recursive schema types ([#3433](https://github.com/david-luna/node-mongodb-native/issues/3433)) ([26bce4a](https://github.com/david-luna/node-mongodb-native/commit/26bce4a8debb65df5a42dc8599e886c9c83de10d))
* **NODE-3920:** validate options are not repeated in connection string ([#3788](https://github.com/david-luna/node-mongodb-native/issues/3788)) ([11631a2](https://github.com/david-luna/node-mongodb-native/commit/11631a2b63e7102602ce2b2e452fd61ee5a46d05))
* **NODE-3924:** read tls files async ([#3776](https://github.com/david-luna/node-mongodb-native/issues/3776)) ([68adaf1](https://github.com/david-luna/node-mongodb-native/commit/68adaf1e5d5ee8cf8f0468380d7a7b3113facc07))
* **NODE-3989:** only accept true and false for boolean options ([#3791](https://github.com/david-luna/node-mongodb-native/issues/3791)) ([e2e36cc](https://github.com/david-luna/node-mongodb-native/commit/e2e36ccbb30de217d7ca2014d8591b574360d557))
* **NODE-4034:** make internal bulk result private ([#3515](https://github.com/david-luna/node-mongodb-native/issues/3515)) ([ebac1f5](https://github.com/david-luna/node-mongodb-native/commit/ebac1f50fafb4b3a229ac60d987d383ed1326803))
* **NODE-4078:** allow comment with estimated doc count ([#3301](https://github.com/david-luna/node-mongodb-native/issues/3301)) ([bed1fe3](https://github.com/david-luna/node-mongodb-native/commit/bed1fe3cc070861b4566ff494512d78a5b1d37a8))
* **NODE-4081:** fix and deprecate change stream resume options ([#3270](https://github.com/david-luna/node-mongodb-native/issues/3270)) ([47adfb3](https://github.com/david-luna/node-mongodb-native/commit/47adfb3db6e38e153e8e78f2b6e4463754775cc6))
* **NODE-4196:** add support for showExpandedEvents in change streams ([#3254](https://github.com/david-luna/node-mongodb-native/issues/3254)) ([9c1782e](https://github.com/david-luna/node-mongodb-native/commit/9c1782e23c7d63dc45d9242e451953fb2ef294a6))
* **NODE-4229:** bump maxWireVersion to 17 ([#3265](https://github.com/david-luna/node-mongodb-native/issues/3265)) ([d13cec2](https://github.com/david-luna/node-mongodb-native/commit/d13cec2e1ae1da2983218275aefccc48d0cfd260))
* **NODE-4267:** support nested fields in type completion for UpdateFilter ([#3259](https://github.com/david-luna/node-mongodb-native/issues/3259)) ([1a9a44c](https://github.com/david-luna/node-mongodb-native/commit/1a9a44cf91847258cf33454d6d3c71c3ba002507))
* **NODE-4294:** mark queryable encryption options beta ([#3300](https://github.com/david-luna/node-mongodb-native/issues/3300)) ([4c07bbb](https://github.com/david-luna/node-mongodb-native/commit/4c07bbbed939516e50369aac44b170ec02ceeba3))
* **NODE-4301:** remove shared lib experimental tags ([#3298](https://github.com/david-luna/node-mongodb-native/issues/3298)) ([3976783](https://github.com/david-luna/node-mongodb-native/commit/3976783331114ec52740982fea3b82b789581ed5))
* **NODE-4336:** deprecate old write concern options and add missing writeConcern to MongoClientOptions ([#3340](https://github.com/david-luna/node-mongodb-native/issues/3340)) ([d2b6ad8](https://github.com/david-luna/node-mongodb-native/commit/d2b6ad8da39d2dd5c01ee7e7ad9622ad65e515f0))
* **NODE-4385:** add cmap pool pausing functionality ([#3321](https://github.com/david-luna/node-mongodb-native/issues/3321)) ([335ee55](https://github.com/david-luna/node-mongodb-native/commit/335ee55d04d4f7f5a6a0dfb06884dd318dc0fc2d))
* **NODE-4436:** update minimum supported node version ([#3496](https://github.com/david-luna/node-mongodb-native/issues/3496)) ([cca5362](https://github.com/david-luna/node-mongodb-native/commit/cca53621a00dcebc224908ce050b37862fda0f12))
* **NODE-4484:** add experimental support for disambiguatedPaths in change stream documents ([#3365](https://github.com/david-luna/node-mongodb-native/issues/3365)) ([846365a](https://github.com/david-luna/node-mongodb-native/commit/846365a5ef58acb53480fbd5a7e0e83cbfed2a3e))
* **NODE-4503:** throw original error when server attaches NoWritesPerformed label ([#3441](https://github.com/david-luna/node-mongodb-native/issues/3441)) ([a7dab96](https://github.com/david-luna/node-mongodb-native/commit/a7dab96cf0a148bc411eb943d4433ba659451117))
* **NODE-4509:** send 1 with hello commands ([#3508](https://github.com/david-luna/node-mongodb-native/issues/3508)) ([cc8ea1d](https://github.com/david-luna/node-mongodb-native/commit/cc8ea1dbf60b4a0484f4acdc107391d0449d70c8))
* **NODE-4519:** deprecate promiseLibrary and PromiseProvider ([#3403](https://github.com/david-luna/node-mongodb-native/issues/3403)) ([5c322b6](https://github.com/david-luna/node-mongodb-native/commit/5c322b647fb878534f612329e1ac99daad6405d2))
* **NODE-4521:** remove custom promise library support ([#3498](https://github.com/david-luna/node-mongodb-native/issues/3498)) ([af36ebb](https://github.com/david-luna/node-mongodb-native/commit/af36ebbbe231722ed55b53d3dece5567e281587a))
* **NODE-4522:** remove callback support ([#3499](https://github.com/david-luna/node-mongodb-native/issues/3499)) ([52853ff](https://github.com/david-luna/node-mongodb-native/commit/52853fff46ca01454f62b164ec3c7465c1fc0279))
* **NODE-4547:** mark all callback APIs as deprecated ([#3388](https://github.com/david-luna/node-mongodb-native/issues/3388)) ([a983f14](https://github.com/david-luna/node-mongodb-native/commit/a983f147776e38a8c09a063120f64d5053619842))
* **NODE-4548:** export ChangeStream class from top-level ([#3357](https://github.com/david-luna/node-mongodb-native/issues/3357)) ([48f295a](https://github.com/david-luna/node-mongodb-native/commit/48f295a2ab38e284c9437300aab35a4678650c87))
* **NODE-4598:** close cursor on early loop break ([#3502](https://github.com/david-luna/node-mongodb-native/issues/3502)) ([30c0aee](https://github.com/david-luna/node-mongodb-native/commit/30c0aeeb99f7ff21d990dcf0dfa9de677acb7905))
* **NODE-4607:** add exports needed by legacy client ([#3396](https://github.com/david-luna/node-mongodb-native/issues/3396)) ([972f760](https://github.com/david-luna/node-mongodb-native/commit/972f760947330d11895579acc63b509fcaac893c))
* **NODE-4634:** add support for bulk FindOperators.hint() ([#3408](https://github.com/david-luna/node-mongodb-native/issues/3408)) ([8758890](https://github.com/david-luna/node-mongodb-native/commit/87588901c620f3cf350acf188726c45a4acf30c4))
* **NODE-4650:** handle handshake errors with SDAM ([#3426](https://github.com/david-luna/node-mongodb-native/issues/3426)) ([cbe7533](https://github.com/david-luna/node-mongodb-native/commit/cbe75332d767a921551d71ea5725fac250906b00))
* **NODE-4681:** deprecate modify result ([#3459](https://github.com/david-luna/node-mongodb-native/issues/3459)) ([6a8776c](https://github.com/david-luna/node-mongodb-native/commit/6a8776c32c8c63beb7871458413baadd9e126efa))
* **NODE-4683:** make ChangeStream an async iterable ([#3454](https://github.com/david-luna/node-mongodb-native/issues/3454)) ([df8d9a4](https://github.com/david-luna/node-mongodb-native/commit/df8d9a4f2bb68f747ecb2b4d88a9137ca4f6ecb4))
* **NODE-4684:** remove collection insert, update, remove methods ([#3500](https://github.com/david-luna/node-mongodb-native/issues/3500)) ([14427d1](https://github.com/david-luna/node-mongodb-native/commit/14427d1b07518cbb3ca36dfbd24f02cd2e486835))
* **NODE-4691:** interrupt in-flight operations on heartbeat failure ([#3457](https://github.com/david-luna/node-mongodb-native/issues/3457)) ([e641bd4](https://github.com/david-luna/node-mongodb-native/commit/e641bd44ef39d64b8b572e7a8ab6bfc71a2b4bed))
* **NODE-4696:** add FaaS env information to client metadata ([#3626](https://github.com/david-luna/node-mongodb-native/issues/3626)) ([0424080](https://github.com/david-luna/node-mongodb-native/commit/04240809f71bb8c2f88d50344d2b8d0d1d2ceea8))
* **NODE-4720:** Add log messages to CMAP spec ([#3645](https://github.com/david-luna/node-mongodb-native/issues/3645)) ([b27f385](https://github.com/david-luna/node-mongodb-native/commit/b27f385fe6a2bc53b3902465a570d832f52df4e6))
* **NODE-4721:** add aws-sdk as optional dependency ([#3446](https://github.com/david-luna/node-mongodb-native/issues/3446)) ([b879cb5](https://github.com/david-luna/node-mongodb-native/commit/b879cb590e1c1880d12522aea2a3ac3a66e6031d))
* **NODE-4733:** deprecate result and getLastOp ([#3458](https://github.com/david-luna/node-mongodb-native/issues/3458)) ([a143d3b](https://github.com/david-luna/node-mongodb-native/commit/a143d3bc6768076fe65368feac0726ca201d4bb0))
* **NODE-4738:** remove dot notation support by default ([#3520](https://github.com/david-luna/node-mongodb-native/issues/3520)) ([26145df](https://github.com/david-luna/node-mongodb-native/commit/26145dfcca55f889e6f03a4e38f8af21039f8795))
* **NODE-4751:** drop support for client encryption &lt; 2.3.0 ([#3521](https://github.com/david-luna/node-mongodb-native/issues/3521)) ([3dae6da](https://github.com/david-luna/node-mongodb-native/commit/3dae6da24cba749597e1e8c378423c071847c5f6))
* **NODE-4756:** ok 1 with write concern failure event changes ([#3525](https://github.com/david-luna/node-mongodb-native/issues/3525)) ([fee783c](https://github.com/david-luna/node-mongodb-native/commit/fee783cdafab02d8a022d08a9c3299e2da809d74))
* **NODE-4757:** deprecate unused PipeOptions ([#3466](https://github.com/david-luna/node-mongodb-native/issues/3466)) ([1a5e619](https://github.com/david-luna/node-mongodb-native/commit/1a5e619f13c3112d75f7b40d2e2cbde027de7f0b))
* **NODE-4767:** Change abstract cursor return type ([#3531](https://github.com/david-luna/node-mongodb-native/issues/3531)) ([410ef30](https://github.com/david-luna/node-mongodb-native/commit/410ef3030ec0de03b9f9888ad66ff66b6229e302))
* **NODE-4774:** deprecate cursor forEach ([#3622](https://github.com/david-luna/node-mongodb-native/issues/3622)) ([8d76a71](https://github.com/david-luna/node-mongodb-native/commit/8d76a7173fb8ac70c0f097366830da273c8a4d94))
* **NODE-4791:** deprecate duplicate bulk methods ([#3623](https://github.com/david-luna/node-mongodb-native/issues/3623)) ([2839e95](https://github.com/david-luna/node-mongodb-native/commit/2839e95256094cbf75fae2753d2e40551c04d87c))
* **NODE-4795:** deprecate addUser helper ([#3624](https://github.com/david-luna/node-mongodb-native/issues/3624)) ([53a0aae](https://github.com/david-luna/node-mongodb-native/commit/53a0aae584fb33b598e16dcea5dc559c3d8dca5e))
* **NODE-4796:** remove addUser and collection.stats APIs ([#3781](https://github.com/david-luna/node-mongodb-native/issues/3781)) ([e79ac9d](https://github.com/david-luna/node-mongodb-native/commit/e79ac9da9fce35e1ea9b26fc4a97a79826a6a687))
* **NODE-4809:** deprecate the existing logger ([#3464](https://github.com/david-luna/node-mongodb-native/issues/3464)) ([1eea4f0](https://github.com/david-luna/node-mongodb-native/commit/1eea4f0f5821bb44c86f653d5a3a6c022a5cf55b))
* **NODE-4810:** define the new Logger ([#3475](https://github.com/david-luna/node-mongodb-native/issues/3475)) ([6ef11d7](https://github.com/david-luna/node-mongodb-native/commit/6ef11d70c07e2e223d376e7527354ddf758a163a))
* **NODE-4814:** implement remaining severity logging methods ([#3629](https://github.com/david-luna/node-mongodb-native/issues/3629)) ([d7a8079](https://github.com/david-luna/node-mongodb-native/commit/d7a80790d8f629e25ff090ef8c2d8c6a7b0b0a07))
* **NODE-4815:** stringify and truncate BSON documents in log messages ([#3635](https://github.com/david-luna/node-mongodb-native/issues/3635)) ([d6bd1d1](https://github.com/david-luna/node-mongodb-native/commit/d6bd1d1602c213e5c46a702163351d1865cdc727))
* **NODE-4817:** remove legacy logger ([#3518](https://github.com/david-luna/node-mongodb-native/issues/3518)) ([28c7cdd](https://github.com/david-luna/node-mongodb-native/commit/28c7cdd6a634f516092676e2e0e1e9272f8485cb))
* **NODE-4867:** adopt BSON v5 ([#3490](https://github.com/david-luna/node-mongodb-native/issues/3490)) ([b850868](https://github.com/david-luna/node-mongodb-native/commit/b850868eb217c98e86b9657d199ac938b1f0a97a))
* **NODE-4877:** Add support for useBigInt64 ([#3519](https://github.com/david-luna/node-mongodb-native/issues/3519)) ([917668c](https://github.com/david-luna/node-mongodb-native/commit/917668c0bc42dbfa0a00869daa223f953f28c2e2))
* **NODE-4898:** aws credential providers now optional peerDependency ([#3497](https://github.com/david-luna/node-mongodb-native/issues/3497)) ([b9e4c7c](https://github.com/david-luna/node-mongodb-native/commit/b9e4c7c5f3f80a354090b92bd5162fc1c96e8e28))
* **NODE-4899:** support only snappy 7 or later ([#3491](https://github.com/david-luna/node-mongodb-native/issues/3491)) ([21db1a9](https://github.com/david-luna/node-mongodb-native/commit/21db1a9e4af0fa29cf84a151a2b93447400c67f0))
* **NODE-4924:** remove mapReduce collection helper ([#3511](https://github.com/david-luna/node-mongodb-native/issues/3511)) ([10d757a](https://github.com/david-luna/node-mongodb-native/commit/10d757a89e74b722d300450665f076aeae4970db))
* **NODE-4925:** remove deprecated options and types ([#3513](https://github.com/david-luna/node-mongodb-native/issues/3513)) ([8f8ea45](https://github.com/david-luna/node-mongodb-native/commit/8f8ea453bd3c03e5a5fe357d32821a1d5735ebcf))
* **NODE-4929:** Add OIDC Azure workflow ([#3670](https://github.com/david-luna/node-mongodb-native/issues/3670)) ([b3482f3](https://github.com/david-luna/node-mongodb-native/commit/b3482f32551ea5fcfefa861eca52961a99c82fe3))
* **NODE-4950:** remove bson-ext import ([#3523](https://github.com/david-luna/node-mongodb-native/issues/3523)) ([1470115](https://github.com/david-luna/node-mongodb-native/commit/147011599b0ad376116951e9058cfba3a67a06d0))
* **NODE-4961:** remove command result from commit and abort transaction APIs ([#3784](https://github.com/david-luna/node-mongodb-native/issues/3784)) ([71c5936](https://github.com/david-luna/node-mongodb-native/commit/71c593685735a08d5d7503120464a7c23ba20a46))
* **NODE-4970:** deprecate collStats collection helper ([#3638](https://github.com/david-luna/node-mongodb-native/issues/3638)) ([325c4bc](https://github.com/david-luna/node-mongodb-native/commit/325c4bc37decdf12e957bfad8bd4ee4d28b1bf95))
* **NODE-4986:** remove callbacks from ClientEncryption encrypt, decrypt, and createDataKey ([#3797](https://github.com/david-luna/node-mongodb-native/issues/3797)) ([51a573f](https://github.com/david-luna/node-mongodb-native/commit/51a573fe99506b81c7ab808898eb9eb63f58f600))
* **NODE-5004:** dont create or drop ecc collections ([#3660](https://github.com/david-luna/node-mongodb-native/issues/3660)) ([2264fbb](https://github.com/david-luna/node-mongodb-native/commit/2264fbb5a9c99ced4cb3c3d71ff2a59e4505f898))
* **NODE-5008:** add zstd and kerberos to peer deps ([#3691](https://github.com/david-luna/node-mongodb-native/issues/3691)) ([9561f32](https://github.com/david-luna/node-mongodb-native/commit/9561f32a9dda6969be7f727c9bd1bd96980f5e95))
* **NODE-5016:** compile ts with target es2020 ([#3545](https://github.com/david-luna/node-mongodb-native/issues/3545)) ([def266a](https://github.com/david-luna/node-mongodb-native/commit/def266a63d3b6f4a2996e6e437fe8895a05666d8))
* **NODE-5019:** add runCursorCommand API ([#3655](https://github.com/david-luna/node-mongodb-native/issues/3655)) ([4da926e](https://github.com/david-luna/node-mongodb-native/commit/4da926e0989b97cfbdf8384bd197dd6ed204fd12))
* **NODE-5034:** support OIDC auth options ([#3557](https://github.com/david-luna/node-mongodb-native/issues/3557)) ([20a4fec](https://github.com/david-luna/node-mongodb-native/commit/20a4fec5fa013c41f525f8c8c465b8f0db380bb2))
* **NODE-5035:** enable OIDC authentication ([#3577](https://github.com/david-luna/node-mongodb-native/issues/3577)) ([35879f6](https://github.com/david-luna/node-mongodb-native/commit/35879f66dd1bd906d6b38cb7cd21ff1fb51c52a1))
* **NODE-5036:** reauthenticate OIDC and retry ([#3589](https://github.com/david-luna/node-mongodb-native/issues/3589)) ([a41846d](https://github.com/david-luna/node-mongodb-native/commit/a41846db3d769e2c10aedbf6feec53271fdb0a48))
* **NODE-5050:** support GCP automatic credential fetch for CSFLE ([#3574](https://github.com/david-luna/node-mongodb-native/issues/3574)) ([722a4a6](https://github.com/david-luna/node-mongodb-native/commit/722a4a6c613e4c169b51f14251a8fb4bebc1cf2a))
* **NODE-5071:** support additional time series options ([#3667](https://github.com/david-luna/node-mongodb-native/issues/3667)) ([ccf555d](https://github.com/david-luna/node-mongodb-native/commit/ccf555d069f3bd0eb7e7b2cca0d5ecdc7d571332))
* **NODE-5077:** automatic Azure kms credential refresh ([#3599](https://github.com/david-luna/node-mongodb-native/issues/3599)) ([8e87e5c](https://github.com/david-luna/node-mongodb-native/commit/8e87e5c5be04902a75887c968f06325c1c7f0477))
* **NODE-5166:** bump max wire version for 7.0 ([#3659](https://github.com/david-luna/node-mongodb-native/issues/3659)) ([561229b](https://github.com/david-luna/node-mongodb-native/commit/561229ba53c2ea422da01625adf5597556332fee))
* **NODE-5169:** Implement emergency logger ([#3610](https://github.com/david-luna/node-mongodb-native/issues/3610)) ([d502eb0](https://github.com/david-luna/node-mongodb-native/commit/d502eb0eb1d2f56ae3603a2da665a79040bc898c))
* **NODE-5186:** remove duplicate BulkWriteResult accessors ([#3766](https://github.com/david-luna/node-mongodb-native/issues/3766)) ([8693987](https://github.com/david-luna/node-mongodb-native/commit/8693987b66dff745c8421ac9cdc29dc772b1f675))
* **NODE-5188:** add alternative runtime detection to client metadata ([#3636](https://github.com/david-luna/node-mongodb-native/issues/3636)) ([2a26de3](https://github.com/david-luna/node-mongodb-native/commit/2a26de3a2cd95b4fc21918a96dd21dc4bc62000a))
* **NODE-5189:** deprecate tcp keepalive options ([#3621](https://github.com/david-luna/node-mongodb-native/issues/3621)) ([cc7c75a](https://github.com/david-luna/node-mongodb-native/commit/cc7c75a64720efe40b70f952e77c1d99d269bf06))
* **NODE-5190:** remove deprecated keep alive options ([#3771](https://github.com/david-luna/node-mongodb-native/issues/3771)) ([7ade907](https://github.com/david-luna/node-mongodb-native/commit/7ade9079fa78538069604a5b42ad13ffbb80af46))
* **NODE-5191:** OIDC Auth Updates ([#3637](https://github.com/david-luna/node-mongodb-native/issues/3637)) ([c52a4ed](https://github.com/david-luna/node-mongodb-native/commit/c52a4edfb79934249ea58703b9ddd4a94ef34418))
* **NODE-5207:** deprecate unsupported runCommand options and add spec tests ([#3643](https://github.com/david-luna/node-mongodb-native/issues/3643)) ([d6d76b4](https://github.com/david-luna/node-mongodb-native/commit/d6d76b4f239ab3d53e867a5c9ace9e18aa12886a))
* **NODE-5233:** prevent session from one client from being used on another ([#3790](https://github.com/david-luna/node-mongodb-native/issues/3790)) ([9268b35](https://github.com/david-luna/node-mongodb-native/commit/9268b35d5ba0736ff38e691024d89f1ac6c28515))
* **NODE-5241:** add option to return modified document ([#3710](https://github.com/david-luna/node-mongodb-native/issues/3710)) ([d9c2600](https://github.com/david-luna/node-mongodb-native/commit/d9c2600daf3bb6c8106e0f3a27cb2f12b770c8eb))
* **NODE-5243:** add change stream split event ([#3745](https://github.com/david-luna/node-mongodb-native/issues/3745)) ([1c84f82](https://github.com/david-luna/node-mongodb-native/commit/1c84f82424acb23b510fdc10e64f304eafecfc1d))
* **NODE-5274:** deprecate write concern options ([#3752](https://github.com/david-luna/node-mongodb-native/issues/3752)) ([1f880ea](https://github.com/david-luna/node-mongodb-native/commit/1f880eaea6e3bc2aa0bf48a70d020a4f9271286d))
* **NODE-5287:** deprecate ssl options ([#3743](https://github.com/david-luna/node-mongodb-native/issues/3743)) ([f9b5677](https://github.com/david-luna/node-mongodb-native/commit/f9b5677657a05b22cc47c20f910e6ae264da8717))
* **NODE-5314:** add search index helpers ([#3672](https://github.com/david-luna/node-mongodb-native/issues/3672)) ([f647542](https://github.com/david-luna/node-mongodb-native/commit/f64754211fe9c142558e3fe9db3adf606d204fc9))
* **NODE-5319:** mark search index api public ([#3741](https://github.com/david-luna/node-mongodb-native/issues/3741)) ([c015e54](https://github.com/david-luna/node-mongodb-native/commit/c015e5446dbeccfa4d63a4a6f46d06add74deb8b))
* **NODE-5376:** remove deprecated ssl options ([#3755](https://github.com/david-luna/node-mongodb-native/issues/3755)) ([ee56c8e](https://github.com/david-luna/node-mongodb-native/commit/ee56c8eebf22b2f90885513e699d209c63379846))
* **NODE-5396:** add `mongodb-js/saslprep` as a required dependency ([#3815](https://github.com/david-luna/node-mongodb-native/issues/3815)) ([bd031fc](https://github.com/david-luna/node-mongodb-native/commit/bd031fc26bdbae7ac8a73cccc06e11da7160d656))
* **NODE-5407:** update bson to 5.4.0 ([#3754](https://github.com/david-luna/node-mongodb-native/issues/3754)) ([6a574cf](https://github.com/david-luna/node-mongodb-native/commit/6a574cf94e8cb923ff33f3a1d241a33d7fd90eb0))
* **NODE-5409:** allow socks to be installed optionally ([#3782](https://github.com/david-luna/node-mongodb-native/issues/3782)) ([787bdbf](https://github.com/david-luna/node-mongodb-native/commit/787bdbf3f7bd974aca1347de427e973217c90009))
* **NODE-5415:** bump minimum Node.js version to v16.20.1 ([#3760](https://github.com/david-luna/node-mongodb-native/issues/3760)) ([de158b2](https://github.com/david-luna/node-mongodb-native/commit/de158b245d809e6600c178303a033997d4181ade))
* **NODE-5430:** make AutoEncrypter and MongoClient.autoEncrypter internal ([#3789](https://github.com/david-luna/node-mongodb-native/issues/3789)) ([b16ef9e](https://github.com/david-luna/node-mongodb-native/commit/b16ef9ed2cbb141c1c8c071ed0d51bc0993dc423))
* **NODE-5444:** emit deprecation warning for useNewUrlParser and useUnifiedTopology ([#3792](https://github.com/david-luna/node-mongodb-native/issues/3792)) ([c08060d](https://github.com/david-luna/node-mongodb-native/commit/c08060d074dfe6f222feb360589ac52f9fa90b6d))
* **NODE-5470:** convert remaining FLE to TS and drop support for `onKMSProvidersRefresh` ([#3787](https://github.com/david-luna/node-mongodb-native/issues/3787)) ([844aa52](https://github.com/david-luna/node-mongodb-native/commit/844aa52640baf69c0b6dacdb3d11add4ca24d8f2))
* **NODE-5484:** mark MongoError for internal use and remove Node14 cause assignment logic ([#3800](https://github.com/david-luna/node-mongodb-native/issues/3800)) ([a17b0af](https://github.com/david-luna/node-mongodb-native/commit/a17b0af1a2ae112b7e96da86a8761d5c15d616cf))
* **NODE-5490:** bump kerberos compatibility to ^2.0.1 ([#3798](https://github.com/david-luna/node-mongodb-native/issues/3798)) ([1044be1](https://github.com/david-luna/node-mongodb-native/commit/1044be14ca69ea4c367bf79735894deadf166d6e))
* **NODE-5508:** remove EvalOperation and EvalOptions ([#3795](https://github.com/david-luna/node-mongodb-native/issues/3795)) ([225cb81](https://github.com/david-luna/node-mongodb-native/commit/225cb8184295c6ad934571c2a0cb7ef6bcf8af50))
* **NODE-5566:** add ability to provide CRL file via tlsCRLFile ([#3834](https://github.com/david-luna/node-mongodb-native/issues/3834)) ([33c86c9](https://github.com/david-luna/node-mongodb-native/commit/33c86c923e0ccfcb61f670c31efd145542bd4980))
* **NODE-5584:** adopt bson v6 and mongodb-client-encryption v6 ([#3845](https://github.com/david-luna/node-mongodb-native/issues/3845)) ([7bef363](https://github.com/david-luna/node-mongodb-native/commit/7bef3632da73f20431952b99a0d11e9aac001c12))
* **NODE-5634:** bump bson version to ^6.1.0 ([#3866](https://github.com/david-luna/node-mongodb-native/issues/3866)) ([c6edabb](https://github.com/david-luna/node-mongodb-native/commit/c6edabb8fa4c6f8d80b028a96eacd26975460f8a))


### Bug Fixes

* **NODE-3144:** pool clear event ordering and retryability tests ([#3407](https://github.com/david-luna/node-mongodb-native/issues/3407)) ([bdc0d67](https://github.com/david-luna/node-mongodb-native/commit/bdc0d675598805f725806f95714cf33aacf3d2dc))
* **NODE-3712,NODE-4546:** electionId should be ordered before setVersion ([#3174](https://github.com/david-luna/node-mongodb-native/issues/3174)) ([ca51fec](https://github.com/david-luna/node-mongodb-native/commit/ca51feca25ab1413df7efe9e79b1de051ceb21eb))
* **NODE-3921:** error on invalid TLS option combinations ([#3405](https://github.com/david-luna/node-mongodb-native/issues/3405)) ([1a550df](https://github.com/david-luna/node-mongodb-native/commit/1a550df3aa328f8c1790c0e02cd1cdd4731b88f8))
* **NODE-3986:** unskip MONGODB-AWS test ([#3397](https://github.com/david-luna/node-mongodb-native/issues/3397)) ([5676f81](https://github.com/david-luna/node-mongodb-native/commit/5676f8116a7d07faf73f47b000a6fb2f462ab681))
* **NODE-3998:** metadata duplication in handshake ([#3615](https://github.com/david-luna/node-mongodb-native/issues/3615)) ([6d894d6](https://github.com/david-luna/node-mongodb-native/commit/6d894d6652d6a286d8a699f4be0a7127a795b1ac))
* **NODE-4125:** change stream resumability ([#3289](https://github.com/david-luna/node-mongodb-native/issues/3289)) ([aa5f97e](https://github.com/david-luna/node-mongodb-native/commit/aa5f97ec65ca49f5320812ae36044f525a8fd9c8))
* **NODE-4159,NODE-4512:** remove servers with incorrect setName from topology and fix unix socket parsing ([#3348](https://github.com/david-luna/node-mongodb-native/issues/3348)) ([00dcf2d](https://github.com/david-luna/node-mongodb-native/commit/00dcf2d51fb27c2b259f8dbf6aedf81196c5f98c))
* **NODE-4186:** accept ReadPreferenceLike in TransactionOptions type ([#3425](https://github.com/david-luna/node-mongodb-native/issues/3425)) ([dc62bcb](https://github.com/david-luna/node-mongodb-native/commit/dc62bcb158e52f4fbc6536f513bc2cab6d01640b))
* **NODE-4262:** make startSession work without a connection ([#3286](https://github.com/david-luna/node-mongodb-native/issues/3286)) ([89ad7c3](https://github.com/david-luna/node-mongodb-native/commit/89ad7c3e5f3ae9ac485b7e1ff6699aed32e2eb34))
* **NODE-4273:** pass 'comment' option through to distinct command ([#3339](https://github.com/david-luna/node-mongodb-native/issues/3339)) ([753ecfe](https://github.com/david-luna/node-mongodb-native/commit/753ecfed437138808f21e31d436a58a44f3513b9))
* **NODE-4281:** ensure that the driver always uses Node.js timers ([#3275](https://github.com/david-luna/node-mongodb-native/issues/3275)) ([4501a1c](https://github.com/david-luna/node-mongodb-native/commit/4501a1ce55ba4adf141fdb851ccd33ff4f2a4e59))
* **NODE-4413:** set maxTimeMS on getMores when maxAwaitTimeMS is specified ([#3319](https://github.com/david-luna/node-mongodb-native/issues/3319)) ([dcbfd6e](https://github.com/david-luna/node-mongodb-native/commit/dcbfd6e943c2db2fbc223e221a6661996df25fe0))
* **NODE-4423:** better type support for nested objects in query & update ([#3328](https://github.com/david-luna/node-mongodb-native/issues/3328)) ([05e007b](https://github.com/david-luna/node-mongodb-native/commit/05e007b0b5ff98151c3ff972ee2f881b4203639e))
* **NODE-4425:** webpack optional import of FLE issue ([#3324](https://github.com/david-luna/node-mongodb-native/issues/3324)) ([5ab2b05](https://github.com/david-luna/node-mongodb-native/commit/5ab2b0517216b6675bed38824448fd9d598fd096))
* **NODE-4429:** select server sync for endSessions during close ([#3363](https://github.com/david-luna/node-mongodb-native/issues/3363)) ([5086ead](https://github.com/david-luna/node-mongodb-native/commit/5086eadf52e13369f584b9bd64477ab7f3522ff6))
* **NODE-4444:** use Node.js clear timers ([#3327](https://github.com/david-luna/node-mongodb-native/issues/3327)) ([c5cfe21](https://github.com/david-luna/node-mongodb-native/commit/c5cfe214ac320386033effc1b62967efa0eabf46))
* **NODE-4447:** disable causal consistency in implicit sessions ([#3479](https://github.com/david-luna/node-mongodb-native/issues/3479)) ([6566fb5](https://github.com/david-luna/node-mongodb-native/commit/6566fb58400c956bb5e56bd7c8affe2ebf2ce558))
* **NODE-4467:** Add back support for `oplogReplay` option as deprecated ([#3337](https://github.com/david-luna/node-mongodb-native/issues/3337)) ([6c69b7d](https://github.com/david-luna/node-mongodb-native/commit/6c69b7d51d98cf858607b0fdcad41d26691f97db))
* **NODE-4475:** make interrupted message more specific ([#3437](https://github.com/david-luna/node-mongodb-native/issues/3437)) ([5f37cb6](https://github.com/david-luna/node-mongodb-native/commit/5f37cb6454878294ae004d13a5fcf62eef6adbbe))
* **NODE-4496:** counter values incorrecly compared when instance of Long ([#3342](https://github.com/david-luna/node-mongodb-native/issues/3342)) ([d29eb8c](https://github.com/david-luna/node-mongodb-native/commit/d29eb8c2b683f0044accfdb2bb3c1770034f28f3))
* **NODE-4513:** type for nested objects in query & update ([#3349](https://github.com/david-luna/node-mongodb-native/issues/3349)) ([ec1a68f](https://github.com/david-luna/node-mongodb-native/commit/ec1a68f8cdf34763ad3797c3d2b663b55ede3e4e))
* **NODE-4518:** error message with invalid authMechanism is provided (#undefined) ([1a16b7e](https://github.com/david-luna/node-mongodb-native/commit/1a16b7e2c4c2de9890591e9ac0196705684eb62c))
* **NODE-4533:** session support error message and unified test runner ([#3355](https://github.com/david-luna/node-mongodb-native/issues/3355)) ([6a0e502](https://github.com/david-luna/node-mongodb-native/commit/6a0e502139bb09d1eeadf01eb20461cf88d538b0))
* **NODE-4555:** export BSON internally ([#3367](https://github.com/david-luna/node-mongodb-native/issues/3367)) ([4ce6e4c](https://github.com/david-luna/node-mongodb-native/commit/4ce6e4cceea9117048d87af36c18da538f96a20f))
* **NODE-4557:** randomize servers when there are only 2 eligible servers ([#3390](https://github.com/david-luna/node-mongodb-native/issues/3390)) ([ddcfa49](https://github.com/david-luna/node-mongodb-native/commit/ddcfa49e753d0a674ad8a7b8e7c17a540d9734cc))
* **NODE-4583:** revert nested union type support ([#3383](https://github.com/david-luna/node-mongodb-native/issues/3383)) ([7f94f0a](https://github.com/david-luna/node-mongodb-native/commit/7f94f0a19d48cc3e779216a5b4c51881ab8ddbf0))
* **NODE-4591:** only set loadBalanced on handshake when explicitly set ([#3386](https://github.com/david-luna/node-mongodb-native/issues/3386)) ([57e9f2d](https://github.com/david-luna/node-mongodb-native/commit/57e9f2d9a617732f49c7e4dcfa3549912209584e))
* **NODE-4608:** prevent parallel monitor checks ([#3404](https://github.com/david-luna/node-mongodb-native/issues/3404)) ([78bcfe4](https://github.com/david-luna/node-mongodb-native/commit/78bcfe4834d03d7f85bd0aaaf8ffc3a316be372d))
* **NODE-4609:** allow mapping to falsey non-null values in cursors ([#3452](https://github.com/david-luna/node-mongodb-native/issues/3452)) ([1bf6ef1](https://github.com/david-luna/node-mongodb-native/commit/1bf6ef1792deb108f3fc58429b165e9bdd06b4a7))
* **NODE-4621:** ipv6 address handling in HostAddress ([#3410](https://github.com/david-luna/node-mongodb-native/issues/3410)) ([5eb3978](https://github.com/david-luna/node-mongodb-native/commit/5eb3978a71941b88d877f2121910f9612d15e9e5))
* **NODE-4639:** allow PromiseProvider to be null ([#3412](https://github.com/david-luna/node-mongodb-native/issues/3412)) ([d29b3d9](https://github.com/david-luna/node-mongodb-native/commit/d29b3d9db6824c048b75e6a74433d3638a41163f))
* **NODE-4647:** improve error message ([#3409](https://github.com/david-luna/node-mongodb-native/issues/3409)) ([0d3c02e](https://github.com/david-luna/node-mongodb-native/commit/0d3c02e25f5327d3200d8631a5472309d93a6c8c))
* **NODE-4649:** use SDAM handling for errors from min pool size population ([#3424](https://github.com/david-luna/node-mongodb-native/issues/3424)) ([ef3b55d](https://github.com/david-luna/node-mongodb-native/commit/ef3b55dd99eb52972e6cbebb4cb3d2ed2f72c081))
* **NODE-4735:** fix change stream consecutive resumabilty ([#3453](https://github.com/david-luna/node-mongodb-native/issues/3453)) ([89b27e9](https://github.com/david-luna/node-mongodb-native/commit/89b27e93e5416fb74ec716f3dc541c104c3a90ce))
* **NODE-4753:** remove erroneous deprecation of geoNear ([#3465](https://github.com/david-luna/node-mongodb-native/issues/3465)) ([199dcaf](https://github.com/david-luna/node-mongodb-native/commit/199dcaf7b462b1c488544cbdbaecaad0417c62d7))
* **NODE-4783:** handle orphaned operation descriptions ([#3463](https://github.com/david-luna/node-mongodb-native/issues/3463)) ([4c9b4d8](https://github.com/david-luna/node-mongodb-native/commit/4c9b4d846e5ba6e86d0d0592ff8bf76654d0fa51))
* **NODE-4788:** use implementer Writable methods for GridFSBucketWriteStream  ([#3808](https://github.com/david-luna/node-mongodb-native/issues/3808)) ([7955610](https://github.com/david-luna/node-mongodb-native/commit/7955610c67eb500af683866aed631d06521345cc))
* **NODE-4830:** lazily import aws module ([#3476](https://github.com/david-luna/node-mongodb-native/issues/3476)) ([ff375e9](https://github.com/david-luna/node-mongodb-native/commit/ff375e9cfb84c85b7036a7ef0f87385d3ec126bb))
* **NODE-4831:** check map value is not undefined ([#3477](https://github.com/david-luna/node-mongodb-native/issues/3477)) ([9795cdb](https://github.com/david-luna/node-mongodb-native/commit/9795cdb19f8e652b4dc4badd4fe8e6d1a7b837a6))
* **NODE-4834:** ensure that MessageStream is destroyed when connections are destroyed ([#3482](https://github.com/david-luna/node-mongodb-native/issues/3482)) ([8338bae](https://github.com/david-luna/node-mongodb-native/commit/8338bae933c777dee4e7e49dbcf52c4fd7047528))
* **NODE-4854:** set timeout on write and reset on message ([#3582](https://github.com/david-luna/node-mongodb-native/issues/3582)) ([4a7b5ec](https://github.com/david-luna/node-mongodb-native/commit/4a7b5ec7dfcc3d0c4825ee939cb3eaf7bc79347b))
* **NODE-4936:** remove unsupported options from db.command and admin.command ([#3775](https://github.com/david-luna/node-mongodb-native/issues/3775)) ([52cd649](https://github.com/david-luna/node-mongodb-native/commit/52cd649caf2e64aef6d3984c5f2d24af03db4c51))
* **NODE-4977:** load snappy lazily ([#3726](https://github.com/david-luna/node-mongodb-native/issues/3726)) ([865e658](https://github.com/david-luna/node-mongodb-native/commit/865e658e7a341c8e9bd64e411bac2e9f5160820d))
* **NODE-4998:** use ipv4 in socks5 tests for node 18 ([#3538](https://github.com/david-luna/node-mongodb-native/issues/3538)) ([425dbe0](https://github.com/david-luna/node-mongodb-native/commit/425dbe05d7bd1ebc1f77303332b67181aa5ab135))
* **NODE-5027:** revert "ensure that MessageStream is destroyed when connections are destroyed" ([#3552](https://github.com/david-luna/node-mongodb-native/issues/3552)) ([2d178d0](https://github.com/david-luna/node-mongodb-native/commit/2d178d072ddc95740ccea35088312fa57cf6c0b2))
* **NODE-5042:** relax SRV record validation to account for a dot suffix ([#3633](https://github.com/david-luna/node-mongodb-native/issues/3633)) ([ad15881](https://github.com/david-luna/node-mongodb-native/commit/ad158811fb23f27d323f5fcada386abaa415fbe6))
* **NODE-5044:** Write Concern 0 Must Not Affect Read Operations ([#3541](https://github.com/david-luna/node-mongodb-native/issues/3541)) ([#3575](https://github.com/david-luna/node-mongodb-native/issues/3575)) ([10146a4](https://github.com/david-luna/node-mongodb-native/commit/10146a42fcc8d84cd07fb26bde9b2926deee6f1e))
* **NODE-5052:** prevent cursor and changestream close logic from running more than once ([#3562](https://github.com/david-luna/node-mongodb-native/issues/3562)) ([71d0d79](https://github.com/david-luna/node-mongodb-native/commit/71d0d79e012e298be2307a73c097494072224bdb))
* **NODE-5064:** consolidate connection cleanup logic and ensure socket is always closed ([#3572](https://github.com/david-luna/node-mongodb-native/issues/3572)) ([e544d88](https://github.com/david-luna/node-mongodb-native/commit/e544d880b1731fa59ad6a0d740b946e79478cfa6))
* **NODE-5102:** listDatabases nameOnly setting is sent as NaN ([#3742](https://github.com/david-luna/node-mongodb-native/issues/3742)) ([b97132e](https://github.com/david-luna/node-mongodb-native/commit/b97132ea0d39d52192ee9bcf06e85d7e8db0c4ca))
* **NODE-5106:** prevent multiple mongo client connect()s from leaking topology ([#3596](https://github.com/david-luna/node-mongodb-native/issues/3596)) ([eb836bb](https://github.com/david-luna/node-mongodb-native/commit/eb836bbd1d0029c78acead0ec985ec11ea94f978))
* **NODE-5126:** find operations fail when passed an ObjectId as filter ([#3604](https://github.com/david-luna/node-mongodb-native/issues/3604)) ([2647b61](https://github.com/david-luna/node-mongodb-native/commit/2647b6154069731f566a4066a01e5d75bc2318b0))
* **NODE-5171:** allow `upsertedId` to be null in `UpdateResult` ([#3631](https://github.com/david-luna/node-mongodb-native/issues/3631)) ([4b5be21](https://github.com/david-luna/node-mongodb-native/commit/4b5be2121fdcca0879447be24e8e935dfcd14764))
* **NODE-5201:** prevent warning when default value for deprecation option is used ([#3646](https://github.com/david-luna/node-mongodb-native/issues/3646)) ([e7f6e4e](https://github.com/david-luna/node-mongodb-native/commit/e7f6e4e34faa65678a34d14ad5b72aacb5dc8dc7))
* **NODE-5213:** `ChangeStream.tryNext()` should return TChange type ([#3649](https://github.com/david-luna/node-mongodb-native/issues/3649)) ([3b58ca1](https://github.com/david-luna/node-mongodb-native/commit/3b58ca1ec873bab3ed56b2de970f9c513a81c741))
* **NODE-5228:** remove unneeded fields from ConnectionPoolCreatedEvent.options ([#3772](https://github.com/david-luna/node-mongodb-native/issues/3772)) ([7a91714](https://github.com/david-luna/node-mongodb-native/commit/7a9171411e6afeb68d8611e15f49b872648dbc9c))
* **NODE-5249:** remove strict flag from create collection options ([#3677](https://github.com/david-luna/node-mongodb-native/issues/3677)) ([be8faaf](https://github.com/david-luna/node-mongodb-native/commit/be8faaf63996c70e54e9cccb130fd05f64651e34))
* **NODE-5260:** AWS Lambda metadata detection logic is too permissive ([#3663](https://github.com/david-luna/node-mongodb-native/issues/3663)) ([d74d3f9](https://github.com/david-luna/node-mongodb-native/commit/d74d3f9a1b7180542a7fda980e7b15f6f1460be0))
* **NODE-5289:** prevent scram auth from throwing TypeError if saslprep is not a function ([#3727](https://github.com/david-luna/node-mongodb-native/issues/3727)) ([e006347](https://github.com/david-luna/node-mongodb-native/commit/e0063477961bbd9c5ca34953e9afe554a1235581))
* **NODE-5296:** construct error messages for AggregateErrors in Node16+ ([#3682](https://github.com/david-luna/node-mongodb-native/issues/3682)) ([e03178e](https://github.com/david-luna/node-mongodb-native/commit/e03178ebc84e489e9058a72f576646a847470379))
* **NODE-5374:** do not apply cursor transform in Cursor.hasNext ([#3746](https://github.com/david-luna/node-mongodb-native/issues/3746)) ([0668cd8](https://github.com/david-luna/node-mongodb-native/commit/0668cd8d566acb02c9d8cc38bcffe51e1a9cd585))
* **NODE-5412:** drop aws sdk version to match node18 runtime ([#3809](https://github.com/david-luna/node-mongodb-native/issues/3809)) ([1e96e49](https://github.com/david-luna/node-mongodb-native/commit/1e96e49b607791d1c1517e65cf88f51821898b0b))
* **NODE-5548:** ensure that tlsCertificateKeyFile maps to cert and key ([#3819](https://github.com/david-luna/node-mongodb-native/issues/3819)) ([a0955bd](https://github.com/david-luna/node-mongodb-native/commit/a0955bdf935113abbb28d7c7011abc04027be2b0))
* **NODE-5551:** set AWS region from environment variable for STSClient ([#3831](https://github.com/david-luna/node-mongodb-native/issues/3831)) ([e9a5079](https://github.com/david-luna/node-mongodb-native/commit/e9a50793143c53f5f70a720e17cf6683f56f7229))
* **NODE-5588:** recursive calls to next cause memory leak ([#3841](https://github.com/david-luna/node-mongodb-native/issues/3841)) ([9a8fdb2](https://github.com/david-luna/node-mongodb-native/commit/9a8fdb22853a7a84dfa8b8e87a6b5d808ae00b6e))
* **NODE-5592:** withTransaction return type ([#3846](https://github.com/david-luna/node-mongodb-native/issues/3846)) ([05d2725](https://github.com/david-luna/node-mongodb-native/commit/05d2725bf179e4c35ff3735856313bca062c77a8))
* sync showExpandedEvents spec tests ([#3288](https://github.com/david-luna/node-mongodb-native/issues/3288)) ([cfe18f9](https://github.com/david-luna/node-mongodb-native/commit/cfe18f966c6d40f3dcc874b668bac65640275449))


### Performance Improvements

* **NODE-4727:** Improve performance of buffering and cursors ([#3447](https://github.com/david-luna/node-mongodb-native/issues/3447)) ([78b2dd5](https://github.com/david-luna/node-mongodb-native/commit/78b2dd5fc2f591302975eb40ce334c6af8a72f1c))
* **NODE-5017:** skip server selection for session support ([#3580](https://github.com/david-luna/node-mongodb-native/issues/3580)) ([591fc64](https://github.com/david-luna/node-mongodb-native/commit/591fc6487878584fd2b46a5531efbcd8c4f38d8a))


### Reverts

* **NODE-4414:** Improve reliability of SDAM heartbeat error spec tests ([#3346](https://github.com/david-luna/node-mongodb-native/issues/3346)) ([417655a](https://github.com/david-luna/node-mongodb-native/commit/417655ac9d87c1c9ca255dfcc81ca828ffde731a))
